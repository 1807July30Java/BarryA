...
--ADDING A TIME TO THE TABLE TRANSACTION
ALTER TABLE BANK_TRANSACTIONS
MODIFY TRANS_TIME DATE;

--MODIFYING BANK-ACCOUNT TO VARCHAR
ALTER TABLE BANK_ACCOUNT
MODIFY DATE_CREATED VARCHAR2(100);

--DELETING ACCOUNTS
DELETE FROM BANK_ACCOUNT
WHERE ACCOUNT_NAME ='Checking Account';

-- ALTERING BANK_ACCOUNT TABLE FOR FOREIGN KEY CONSTRAINT

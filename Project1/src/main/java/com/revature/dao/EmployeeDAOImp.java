...
/************************************************************************************************************************************************************/
	...
	public List<Employee> getEmployeeByManager(double id) {
		...
		try(Connection con = ConnectionUtil.getConnectionFromFile(filename)){
			...
			lE.add(new Employee(empID, empFirstName, empLastName, empEmail, empPassword, managerID));	
			}
		}catch (SQLException e) {
			return null;
...
/************************************************************************************************************************************************************/
	...
	public Employee getEmployeeInfo(String email) {
		...
		while(rs.next()) {
			...
			emp = new Employee(empID,empFirstName, empLastName, empEmail, managerID);
		}
...
/************************************************************************************************************************************************************/
	public boolean addEmployee(Employee emp, double managerId) {
		...
		emp.setManagerID(managerId);
		 PreparedStatement pstmt = null;
		 try (Connection con = ConnectionUtil.getConnectionFromFile(filename)){
			 String sql = "INSERT INTO EMPLOYEE (EMP_FNAME,EMP_LNAME,EMP_EMAIL,EMP_PASSWORD, MANAGER_ID) VALUES (?,?,?,?,?)";
			 pstmt = con.prepareStatement(sql);
